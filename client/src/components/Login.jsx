...
const Login = () => {
  ...
  return (
    ...
    <div className=' rounded-md shadow-gray-400 shadow-lg md:w-1/3 sm:w-3/5 w-11/12 p-6' >
        <h1 className=' font-semibold text-5xl  font-mono text-center'>Login</h1>
        ...
        <div className=' flex justify-center mt-8 '>
            <button onClick={handleLogin}  className=' bg-white text-black p-2  w-32 rounded-md '>{loading?<ClipLoader size={15} color='black'/>:"Login"}</button>
        </div>

        <div className='flex justify-center mt-6'>
          <p>Not Registered Yet? <Link to='/' className=' underline text-blue-600 cursor-pointer'>Click Here</Link></p>
        </div>
